 ...
 */
package com.xyz.browser.app.config.datasource;
...
@MapperScan(basePackages = {"com.xyz.browser.app.modular.*.dao"})//, "com.xyz.browser.app.modular.hbase.dao"})
...
//        dataSource.setMinEvictableIdleTimeMillis(1800000);//30 min
        dataSource.setMaxEvictableIdleTimeMillis(480000);//8 min

...
public class TransactionServiceImpl implements TransactionService {
    ...
    public Transaction selectByHash(String hash) {
        return this.transactionMapper.selectByHash(hash);
    }

    @Override
    @DataSource(name= DatasourceEnum.DATA_SOURCE_BIZ)
    public List<Transaction> selectByBlockNumber(String blockNumber) {
        return this.transactionMapper.selectByBlockNumber(blockNumber);
    }
